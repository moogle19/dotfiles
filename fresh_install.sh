...
brew cask install alfred appcleaner atext atom beamer brackets chitchat cocoapacketanalyzer controlplane dash disk-inventory-x firefox google-chrome iterm2 java keepassx keepingyouawake macdown psequel sequel-pro slack smoothmouse spectacle spotify teamviewer textmate the-unarchiver thunderbird transmission tunnelblick virtualbox vlc
cd ~/Documents
